...
var _user$project$Main$edit = F2(
	function (model, id) {
		...
		var newPlayers = A2(
			_elm_lang$core$List$map,
			function (player) {
				return _elm_lang$core$Native_Utils.eq(player.playerId, id) ? _elm_lang$core$Native_Utils.update(
					player,
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{players: newPlayers, plays: playUpdate, playerName: '', playerId: _elm_lang$core$Maybe$Nothing});
	});
var _user$project$Main$deletePlay = F2(
	function (model, play) {
		var updateListPlayers = A2(
			_elm_lang$core$List$map,
			function (player) {
				return _elm_lang$core$Native_Utils.eq(player.playerId, play.playerId) ? _elm_lang$core$Native_Utils.update(
					player,
					{playerScore: player.playerScore - (1 * play.points)}) : player;
			},
			model.players);
		var newListPlays = A2(
			_elm_lang$core$List$filter,
			function (p) {
				return (!_elm_lang$core$Native_Utils.eq(p.id, play.id)) ? true : false;
			},
			model.plays);
		return _elm_lang$core$Native_Utils.update(
			model,
			{players: updateListPlayers, plays: newListPlays});
	});
...
var _user$project$Main$Player = F3(
	function (a, b, c) {
		return {playerId: a, playerName: b, playerScore: c};
	});
var _user$project$Main$add = function (model) {
	...
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			players: {ctor: '::', _0: player, _1: model.players},
			playerName: '',
			playerId: _elm_lang$core$Maybe$Nothing
		});
};
...
var _user$project$Main$Play = F4(
	function (a, b, c, d) {
		return {id: a, playerId: b, playerName: c, points: d};
	});
var _user$project$Main$score = F3(
	function (model, scorer, points) {
		...
		var newPlayers = A2(
			_elm_lang$core$List$map,
			function (player) {
				return _elm_lang$core$Native_Utils.eq(player.playerName, scorer.playerName) ? _elm_lang$core$Native_Utils.update(
					player,
					{playerScore: player.playerScore + points}) : player;
			},
			model.players);
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				players: newPlayers,
				plays: {ctor: '::', _0: newPlays, _1: model.plays}
			});
	});
		...
		switch (_p1.ctor) {
			...
			case 'Edit':
				...
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						playerName: _p3.playerName,
						playerId: _elm_lang$core$Maybe$Just(_p3.playerId)
					});
			default:
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(play.playerName),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(player.playerName),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										_elm_lang$core$Basics$toString(player.playerScore)),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
